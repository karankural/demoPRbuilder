qweqwesdFeaturqwee: Automation for PAbout Us Page to reduce manual effort of manual testing, here we will going to automate validation of CSS, nested CSS, response status of hrefs and sources of images.
  @blackbox @1
  ...
  Scenario: About Block row below resource blocks
   ...
   # Asnd I should see CSS ".about-content" in the "about_us_page_About_Us_block_1" region
